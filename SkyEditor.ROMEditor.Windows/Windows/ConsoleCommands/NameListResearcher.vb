        ...
        Public Overrides Async Function MainAsync(Arguments() As String) As Task
            If Arguments.Length > 0 Then
                If File.Exists(Arguments(0)) Then
                    ...
                    Await msg.OpenFile(Arguments(0), CurrentFileSystem)
                    Await msg2.OpenFile(Arguments(0), CurrentFileSystem)
                    ...
                    File.WriteAllText("PSMD Move Name Hashes.txt", output.ToString)
                    File.WriteAllText("PSMD Move Names.txt", nameOutput.ToString)
                    Console.Write("Done.")
                Else
