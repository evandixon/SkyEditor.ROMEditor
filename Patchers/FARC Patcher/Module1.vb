...
Module Module1
    ...
    Sub Main()
        ...
        Console.WriteLine($"Pokemon Super Mystery Dungeon FARC Type 5 Patcher v{Version}")
        Console.WriteLine()
        Dim args = Environment.GetCommandLineArgs
        Console.WriteLine(GetType(Farc).Name)
        ...
        '            Dim sourceFarc As New Farc
        '            sourceFarc.OpenFile(inputFile)

        '            Dim editedFarc As New Farc
